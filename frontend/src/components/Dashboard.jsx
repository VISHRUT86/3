            ...
            <div className="chart-box">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <AreaChart data={graphData}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Area type="monotone" dataKey="income" stroke=" #22FF22" fillOpacity={0.8} fill="#22FF22" />
                  <Area type="monotone" dataKey="expense" stroke="#FF0022" fillOpacity={0.4} fill="#FF0022" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </div>
